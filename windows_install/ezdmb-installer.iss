...
Source: .version-suffix; DestDir: {commonpf}\Kezdmb; Flags: ignoreversion uninsrestartdelete
Source: config.json; DestDir: {commonpf}\ezdmb; Flags: onlyifdoesntexist uninsrestartdelete
